...
namespace Objectia.Core.Messages
{
    public interface IMessageBuilder
    {
        ...
        IMessageBuilder AddToRecipient(string recipient, JObject recipientVariables = null);
        ...
        /// <returns></returns>
        IMessageBuilder AddToRecipientList(IEnumerable<string> recipients);
        ...
        /// <param name="recipient">The recipient details</param>
        /// <returns>IMessageBuilder</returns>
        IMessageBuilder AddCcRecipient(string recipient);
        ...
        /// <param name="recipient">The recipient details</param>
        /// <returns>IMessageBuilder</returns>
        IMessageBuilder AddBccRecipient(string recipient);
