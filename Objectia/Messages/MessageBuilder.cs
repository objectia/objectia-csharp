...
namespace Objectia.Messages
{
    public class MessageBuilder : IMessageBuilder
    {
        ...
        public IMessageBuilder AddToRecipientList(IEnumerable<string> recipients)
        {
        ...
        public IMessageBuilder AddToRecipient(string recipient, JObject recipientVariables = null)
        {
            //check for recipient
            ThrowIf.IsArgumentNull(() => recipient);

            if (_recipientCount == Constants.MAX_RECIPIENTS)
            {
            ...
            if (_message.To == null)
            {
                _message.To = new Collection<string>();
            }
            ...
            if (recipientVariables != null)
            {
                ...
                _message.RecipientVariables[recipient] = recipientVariables;
            }
        ...
        public IMessageBuilder AddCcRecipient(string recipient)
        {
            //check for recipient
            ThrowIf.IsArgumentNull(() => recipient);

            if (_ccCount == Constants.MAX_RECIPIENTS)
            {
            ...
            if (_message.Cc == null)
            {
                _message.Cc = new Collection<string>();
            }
        ...
        public IMessageBuilder AddBccRecipient(string recipient)
        {
            //check for recipient
            ThrowIf.IsArgumentNull(() => recipient);

            if (_bccCount == Constants.MAX_RECIPIENTS)
            {
            ...
            {
                _message.Bcc = new Collection<string>();
            }
            //add to the message
            _message.To.Add(recipient);
            _bccCount++;
